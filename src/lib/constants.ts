...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  {
    ...
    category: 'Web Development',
    description: '',
    image: 'https://imgur.com/Lxmvlk3.png',
  ...
  },
  {
    ...
    category: 'Web Development',
    description: '',
    image: 'https://imgur.com/hus31ll.png',
    imageHint: 'website screenshot',
  ...
  },
  {
    ...
    category: 'Web Development',
    description: '',
    image: 'https://imgur.com/EQCrbnu.png',
    imageHint: 'website screenshot',
  ...
  },
  {
    ...
    category: 'Web Development',
    description: '',
    image: 'https://imgur.com/XfU0hP5.png',
    imageHint: 'website screenshot',
  ...
  },
  {
    ...
    category: 'Social Media Management',
    description: '',
    image: 'https://imgur.com/GiYSLPi.png',
  ...
  },
  {
    ...
    category: 'Social Media Management',
    description: '',
    image: 'https://imgur.com/wB6jhgg.png',
    imageHint: 'instagram profile',
  ...
  },
  {
    ...
    category: 'Social Media Management',
    description: '',
    image: 'https://imgur.com/gEsuvkI.png',
    imageHint: 'instagram profile',
  ...
  },
  {
    ...
    description: '',
    image: 'https://imgur.com/YPiGw17.png',
  ...
  },
  {
    ...
    category: 'Content Marketing',
    description: '',
    image: 'https://imgur.com/hgjUEl3.png',
    imageHint: 'tiktok profile',
  ...
  },
  {
    ...
    category: 'SEO',
    description: '',
    image: 'https://imgur.com/QvWNDZr.png',
    imageHint: 'blog page',
  ...
  },
  {
    ...
    category: 'SEO',
    description: '',
    image: 'https://imgur.com/P5HQzkA.png',
    imageHint: 'blog page',
  ...
  },
  {
    ...
    category: 'SEO',
    description: '',
    image: 'https://imgur.com/5W6ix7V.png',
    imageHint: 'blog page',
...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    content: '&lt;p&gt;Content marketing B2B berfokus pada pembangunan kepercayaan dan otoritas. Buat studi kasus, white paper, webinar, dan artikel blog yang mendalam untuk menunjukkan keahlian Anda. Peta perjalanan pembeli (buyer\'s journey) untuk menyediakan konten yang relevan di setiap tahap, dari kesadaran hingga pengambilan keputusan.&lt;/p&gt;',
  ...
  },
  {
    ...
    content: '&lt;p&gt;Tiga pilar Core Web Vitals adalah Largest Contentful Paint (LCP), First Input Delay (FID), dan Cumulative Layout Shift (CLS). Optimalkan gambar Anda, manfaatkan caching browser, kurangi file JavaScript yang tidak perlu, dan gunakan Content Delivery Network (CDN) untuk meningkatkan kecepatan loading situs Anda secara dramatis.&lt;/p&gt;',
